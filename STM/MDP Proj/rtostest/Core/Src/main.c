...
void moveCarStraight2(double distance)
{
	distance = distance*75;
	//pwmVal_servo = 140;
	pwmVal_servo = 149;
...
//		}
		 ...
		 osDelay(500);
		  switch (key){
			  ...
			  case 'Q': //From Carpark Left
				  if(first)
				  {
					  moveCarLeft903(47);//set a flag to not recall this 100000 times
					  osDelay(50);
					  moveCarRight903(47);
					  osDelay(50);
					  moveCarStraight(5);
